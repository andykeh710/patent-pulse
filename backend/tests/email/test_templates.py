...
def test_instant_alert_template_renders():
    out = _render("instant_alert.html",
        ...
        match_count="3",
        patents=[{"title": "P1", "url": "http://x/p/1", "assignee": "A",
                  "publication_number": "US123", "expiry_status": "active",
...
def test_all_templates_have_no_leftover_tags():
    for name in ("magic_link.html", "instant_alert.html", "weekly_digest.html"):
        out = _render(name,
            ...
            topic_name="T",
            match_count="1",
            patents=[{"title": "P", "url": "x", "assignee": "A",
                       "publication_number": "N", "expiry_status": "active",
                       "abstract_snippet": "S"}],
            greeting="G",
            intro_blurb="I",
