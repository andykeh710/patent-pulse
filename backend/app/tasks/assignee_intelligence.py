...
@celery_app.task(
    bind=True,
    name="app.tasks.assignee_intelligence.generate_assignee_intelligence",
    max_retries=2,
    default_retry_delay=30,
)
def generate_assignee_intelligence_task(
...
@celery_app.task(
    bind=True, name="app.tasks.assignee_intelligence.batch_assignee_intelligence", max_retries=1
)
