    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="mt-3">
          ...
          {/* Figures — embedded from Google Patents (no hosting, no scraping) */}
          {patent.figure_page_url && (
            <div className="mt-4">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
                <iframe
                  src={patent.figure_page_url}
                  className="w-full h-[500px] border-0"
                  title="Patent figures from Google Patents"
                  loading="lazy"
                  sandbox="allow-scripts allow-same-origin"
                />
              </div>
              <p className="text-xs text-gray-400 mt-1">
                Figures &copy; patent office — embedded from Google Patents.{" "}
                <a
