  ...
  return (
    <div className="flex flex-col">
      ...
      <input
        ...
        onChange={(e) => onChange(e.target.value)}
        className="w-32 rounded-lg border border-gray-300 px-2.5 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col">
      ...
      <input
        ...
        placeholder={placeholder}
        onChange={(e) => onChange(e.target.value)}
        className="w-24 rounded-lg border border-gray-300 px-2.5 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
      />
    </div>
  );
}
